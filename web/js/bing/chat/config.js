...
_w['_sydConvTranslation'] = {
  ...
  feedbackSource: '源: 与GPT的对话，',
  feedbackShareConversationQuery: '什么是新版GPT?',
  ...
  warmWelcomeTitle: '欢迎使用新GPT',
  welcomeSubtitleText: '由 AI 支持的网页版 GPT4',
  workToggleDescription: '以及你的结果包括哪些内容',
  feedbackFirstMessage: '非常抱歉没有帮助到你。是否可以详细说明你不喜欢的方面?',
  feedbackPromptMessage: '感谢提醒。请提供反馈，以便GPT团队可以查看。',
  ...
  feedbackFormNotificationBodyText: '感谢你帮助GPT改进！',
  ...
  actionBarTextInputAriaLabel: '询问GPT',
  seeMore: '查看更多',
  seeLess: '查看更少',
  raiSuggestions: '这是什么?',
  ...
  newUserGreet: '嘿，你好！我是GPT，除了简单搜索之外，我还可以帮助你完成各种操作。你可以询问我关于从家庭作业到历史记录到帽子的任何信息。你的想法是什么？',
  newUserSugg1: '搜索运行状况',
  newUserSugg2: '搜索电影',
  newUserSugg3: '创作歌曲',
  ...
  close: '关闭',
  newTopicPrompt: '通过新主题，可以开始与GPT就任何主题进行全新对话',
  typingIndicatorStopRespondingAriaLabel: '停止响应',
  canceling: '正在取消',
  welcomeLearnSegment0: 'GPT由 AI 提供支持，因此可能出现意外和错误。请确保核对事实，并',
  welcomeLearnSegment1: '让我们一起学习。GPT由 AI 提供支持，因此可能出现意外和错误。请确保核对事实，并 ',
  welcomeLearnSegment2: '共享反馈 ',
  welcomeLearnSegment3: '以便我们可以学习和改进!',
  welcomeLearnMessage: '让我们一起学习。GPT由 AI 提供支持，因此可能出现意外和错误。请确保核对事实，并 {0} 以便我们可以学习和改进！',
  ...
  sydneySapphireUpsellContent: '现在就获取使用新 AI 驱动的GPT应用程序吧!',
  sydneySapphireWelcomeText: '欢迎回来! 下面是此页面的一些内容。',
  sydneySapphireConsentTitleText: '使用新GPT提升浏览',
  sydneySapphireConsentMessageText: '允许 Microsoft 访问你的浏览器 Web 内容，以便使用 AI 生成的摘要和新GPT的热点功能更好地个性化你的体验。了解更多信息',
  ...
  mobileUpsellMessage1: '扫描此 QR 码以在移动GPT应用上继续此对话',
  mobileUpsellTitle1: '在手机上继续',
  sydneySapphireUpsellConsentTitle: '是否继续从桌面聊天?',
  sydneySapphireUpsellConsentMessage: '你在其他设备上有一个活动的GPT聊天。是否要继续此对话?',
  ...
  feedbackShareAnswer: '查看此GPT答案',
  feedbackShareGenerated: '查看我使用GPT生成的内容',
  ...
  refresh: '刷新',
  feedbackShareContent: '下面是我使用新的GPT（全球首个 AI支持的应答引擎）生成的答案。单击可查看完整答案，然后请你也来试一试。',
  preview: '预览',
  ...
  notificationMaxTurnsPerDay: '很抱歉，你已达到可在 24 小时内发送到GPT的邮件限制。请稍后回来查看!',
  ...
  muidUsersTermsCond1: '通过单击“开始使用”，并继续与GPT交互，即表示你接受',
  muidUsersTermsCond1Inline: '通过继续与GPT交互，你将接受 ',
  muidUsersTermsCond2: '并确认你已查看',
  muidUserGetStartedText: '开始使用',
  welcomeMobSugg1: 'GPT如何使用 AI?',
  welcomeMobSugg2: 'GPT还可以做什么？',
  ...
  threadsDelete: '删除',
  threadsDescription: '你的GPT AI 支持的 copilot 现可自动保存聊天功能。可以从任何设备、桌面或移动设备访问聊天，并无缝恢复。',
